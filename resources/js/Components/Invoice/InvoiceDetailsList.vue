                    ...
                    <table class="w-full border-collapse table-fixed border-t-0">
                        <thead v-if="i === 0">
                            <tr class="bg-gray-200">
                                ...
                                <!-- Increased width -->
                                <th class="border px-2 py-1" style="width: 80px">Weight</th>
                                <th class="border px-2 py-1" style="width: 80px">Size</th>
                                <th class="border px-2 py-1" style="width: 70px">Rate</th>
                                <th class="border px-2 py-1" style="width: 90px">Qty/Pcs</th>
                                <th class="border px-2 py-1" style="width: 80px">Qty/Kg</th>
                                <th class="border px-2 py-1" style="width: 100px">Amount</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr
                            ...
                            >
                                ...
                                <!-- Increased width -->
                                <td class="border-1 px-2 py-1" style="width: 80px">
                                    {{ product.product.weight }}
                                </td>
                                <td class="border-1 px-2 py-1" style="width: 80px">
                                    {{ product.product.size }}
                                </td>
                                <td class="border-1 px-2 py-1" style="width: 70px">
                                    {{ product.rate }}
                                </td>
                                <td class="border-1 px-2 py-1" style="width: 90px">
                                    {{ product.qty_by_pc }}
                                </td>
                                <td class="border-1 px-2 py-1" style="width: 80px">
                                    {{ product.qty_by_kg }}
                                </td>
                                <td class="border-1 px-2 py-1" style="width: 100px">
                                    {{ product.order_price }}
                                </td>
                            </tr>
                        </tbody>
